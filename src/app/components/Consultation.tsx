...
import Elysian from "../../../public/assets/elysian-logo-2.svg";
...
export default function Consultation() {
  return (
    <footer className="bg-black px-10 py-12 md:p-16">
      <div className="max-w-[100rem] mx-auto">
        ...
        <div className="mt-20">
          <div className="flex flex-col gap-8 md:flex-row md:justify-between">
            <div>
              <Image src={Elysian} alt="Elysian" priority className="w-24" />
              <div className="flex flex-col gap-3 mt-6 text-default text-xs md:text-sm">
            ...
            <div>
              <p className="text-default text-xs md:text-sm">
